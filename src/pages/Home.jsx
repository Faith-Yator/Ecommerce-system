...
KSh 18,399.</p>
        ...
        <div className="card">
          <img src="./src/home/1 (2).jpg" alt="Product 2" />
          <h3>Product 2</h3>
          <p>
...
KSh 27,399</p>
        ...
        <div className="card">
          <img src="./src/home/1 (3).jpg" alt="Product 2" />
          <h3>Product 2</h3>
          <p>
...
KSh 47,000</p>
        ...
        <div className="card">
          <img src="./src/home/1 (4).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 32,699</p>
        ...
        <div className='tv'>
          <h2>Tv's & Audios</h2>
        <div className="card">
          <img src="./src/assets/tv/1 (1).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 8,299</p>
        ...
        <div className="card">
          <img src="./src/assets/tv/1 (4).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 14,099</p>
        ...
        <div className="card">
          <img src="./src/assets/tv/1 (3).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 21,789</p>
        ...
        <div className='tv'>
          <h2>Computers</h2>
        {/* <div className="card">
          <img src=".\src\computers\1 (1).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 18,999</p>
        ...
        <div className="card">
          <img src=".\src\computers\1 (2).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 17,999</p>
        ...
        <div className="card">
          <img src=".\src\computers\1 (3).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 16,999</p>
        ...
        <div className="card">
          <img src=".\src\computers\1 (4).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 1,059.</p>
        ...
        <div className="card">
          <img src=".\src\phone\1 (4).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 16,995
        ...
        <div className="card">
          <img src=".\src\phone\1 (5).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 23,399</p>
        ...
        <div className="card">
          <img src=".\src\phone\1 (3).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 9,799</p>
        ...
        <div className='tv'>
          <h2>Printers</h2>
        <div className="card">
          <img src=".\src\printers\1 (1).jpg" alt="Product 2" />
          <h3>Product 2</h3>
...
KSh 22,559</p>
        ...
        <div className="card">
          <img src=".\src\printers\1 (2).jpg" alt="Product 2" />
          <h3>Product 2</h3>
          <p>Canon PIXMA G2411 All-in-One, Printer<br/>
KSh 21,499</p>
          <button className="add-to-cart-button"onClick={() => handleCardClick('/Cart')}>Add to Cart</button>
        </div>
        {/* <div className="card">
...
KSh 12,000</p>
        ...
        <div className="card">
          <img src=".\src\printers\1 (4).jpg" alt="Product 2" />
          <h3>Product 2</h3>
